...
// ✅ This widget can be called directly from your main navigation
class PushupDetectionScreen extends StatefulWidget {
  const PushupDetectionScreen({super.key});

  @override
  State<PushupDetectionScreen> createState() => _PushupDetectionScreenState();
}

class _PushupDetectionScreenState extends State<PushupDetectionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Pushup Detection"),
